...
<form id="form1" name="form1" method="post" action="City.php">
  <table width="100%" border="0">
    ...
    <tr>
      <td width="50%" align="right">Add City :</td>
	...
	//$pass=$_POST['txtPassword'];
		$query11 = "insert into tbl_city (cityname,statename) values ('$name','$countryname')";		
  ...
  <tr>
	...
	{
	$kk=$row11["id"];
		echo "<tr><td align='center'><a href='DeleteCity.php?ID=$kk'>Delete</a> &nbsp;&nbsp; <a href='EditCity.php?ID=$kk'>Edit</a></td>";
    echo '<td>'.$row11["cityname"].'</td>';
	 echo '<td>'.$row11["statename"].'</td></tr>';
