...
<body>
<form action="EditCategoryCode.php" method="post">
...
<?php
	 ...
	 $_SESSION['mynewsid'] = $id;
	  require_once("../Mydb.php");	
           ...
           $query11 = 'select * from tbl_category where categoryid='.$id;
	$result11 = mysql_query($query11);
	
	while($row11=mysql_fetch_array($result11,MYSQL_ASSOC))
	{
		$ausername=$row11['categoryname'];
...
<table width="100%" border="0">
  <tr>
    <td width="50%" align="right">Category Name :</td>
